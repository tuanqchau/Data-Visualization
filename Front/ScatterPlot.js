...
const ScatterPlot = (props) => {
    ...
    const paint = () => {
        ...
        svg
            ...
            .attr("r", 3)
            .attr("cx", (item , index) => {
                return 5 + settings.bars.x + (1 - settings.bars.ratio + index) * settings.bars.width / (dataset.data.length + 1 - settings.bars.ratio);
            })
            .attr("cy", (item , index) => { //Object.values(item)[1]
